...
void makedir(int ssock);
int recur_delete(char* );
void deletefile(int);
...
void deletefile(int ssock)
{
	int  getfile,ack,msg,msg_2,c,len,n,msg_ok,fail,tmp,req;
       	char fname[MAXLINE] = "";
        FILE *fp;
     	DIR *dp;
	struct dirent *ep;
	char abs_filename[MAXSIZE];	
